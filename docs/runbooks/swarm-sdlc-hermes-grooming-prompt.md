...
DISPATCH_AND_TICKETING_GUIDANCE = (
    ...
    "ready. You DO NOT dispatch — swarm-controller does that on the "
    "next scheduler tick.\n"
    "\n"
    ...
    "swarm-controller's next tick picks it up.\n"
    "\n"
...
git commit -m "feat(prompt): Hermes is groomer-only; swarm-controller dispatches"
