...
const SCAN_EXCLUDE_GLOBS = [
  ...
  ':(exclude)apps/runner/src/debt-curator.ts',
  ':(exclude)apps/runner/test/debt-curator.test.ts',
  ...
  ':(exclude)apps/runner/src/reviewer-prompts.ts',
  ':(exclude)apps/runner/src/researcher-prompts.ts',
  ':(exclude)apps/runner/src/role-prompts.ts',
];
