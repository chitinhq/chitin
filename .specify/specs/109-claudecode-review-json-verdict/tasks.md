...
- [X] T006 [P] [US2] Add a unit test in `review_mode_test.go` for the prose-only case — assert the driver emits `StatusFailed` with `malformed_verdict` in the explanation and the raw output truncated to 1 KiB
