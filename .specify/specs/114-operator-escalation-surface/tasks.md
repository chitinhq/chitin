...
- [x] T013 [US2] Add an integration test for the digest job — Temporal testsuite env, stub queue producing a known result, assert the Discord post fires with the right markdown body
