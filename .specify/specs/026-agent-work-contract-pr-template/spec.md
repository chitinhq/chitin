# 026 — Standardized agent work-contract PR template
...
Every worker PR carries a structured contract section (ticket-id, spec-binding, files-touched, tests-added, invariants-honored). Operator + reviewers can audit at a glance.

## File-system scope (proposed)

- `docs/governance-setup-extras/pr-template.md`
- `.github/PULL_REQUEST_TEMPLATE.md`
- `.specify/specs/026-agent-work-contract-pr-template/**`
