...
from chitin_telemetry import migrations, prompts
from chitin_telemetry.detectors import Finding, run_all_detectors
...
try:
    from chitin_telemetry import llm as _llm_module
except ImportError:
...
def _call_qwen(prompt: str) -> Optional[str]:
    ...
    subprocess invocation if `chitin_telemetry.llm` is unavailable, and in both cases
