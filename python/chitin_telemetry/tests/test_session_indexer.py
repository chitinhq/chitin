"""Tests for chitin_telemetry.session_indexer with boundary conditions."""
import json
import os
import sqlite3
import tempfile
...
from chitin_telemetry.session_indexer import (
    _CC_SESSION_RE,
    _CODEX_EVENT_RE,
    _CHAIN_EVENT_RE,
    _line_hash,
...
class TestCheckpoints:
    def test_save_and_load_checkpoint(self, db, tmp_path):
        from chitin_telemetry.session_indexer import _save_checkpoint, _get_checkpoint
...
class TestBulkIndex:
    def test_bulk_index_codex(self, db, tmp_path):
        ...
        from chitin_telemetry.session_indexer import _save_checkpoint, _file_fingerprint
