"""Tests for chitin_telemetry.reporter."""
import os
import re
import tempfile
...
from chitin_telemetry.beliefs import ingest_wiki_graph
from chitin_telemetry.reporter import generate_daily_report, _get_summary_stats
...
def test_discord_post_skipped_on_quiet_day(monkeypatch):
    ...
    import chitin_telemetry.reporter as reporter_mod
