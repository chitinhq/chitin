...
// Driver wraps the GitHub Copilot CLI behind the spec-075 AgentDriver contract
...
// Card returns the Copilot capability card. Copilot covers implementation and
// is the swarm's natural home for the code.review capability.
func (d *Driver) Card() driver.CapabilityCard {
	return driver.CapabilityCard{
		DriverID:     id,
		Version:      version,
		AgentRuntime: "copilot-cli",
