...
// authoritative schema when it needs to disambiguate edge cases
// (spec 110 FR-003 — parity with spec 109 FR-002).
...
// required by spec 110 FR-003 (parity with spec 109 FR-001).
...
// stdout. Per spec 110 FR-004 (identical to spec 109 FR-003), applies in order:
//
