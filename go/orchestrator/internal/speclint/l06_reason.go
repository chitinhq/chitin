...
const (
	ruleL06 = "L06"
	// l06SeverityError is the only severity L06 emits — an undeclared
	// reason value is unambiguously broken (a literal in an event
	// payload that no canonical FR-NNN defines).
	l06SeverityError = "error"
)
