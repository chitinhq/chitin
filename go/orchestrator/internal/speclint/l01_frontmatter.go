...
// Violation, Severity, SeverityError, SeverityWarning are declared in
// lint.go — the canonical home for the shared types. Each rule file
// uses them by name; duplicating the type here was the original cause
// of the speclint package failing to build when T003-T008 PRs landed
// together. Leaving the symbols undeclared here forces resolution to
// the canonical lint.go declarations.
