...
// identical digests.
//
// The package also provides sequence fingerprinting for doom loop detection,
// tracking patterns of repeated tool calls.
package canon
...
// NOTE: v1 also defined SequenceTracker/Pattern for doom-loop detection.
// Those are governance territory; removed from Phase 1 observability-only.
// See v1 sequence.go in chitinhq/chitin-archive if needed later.
